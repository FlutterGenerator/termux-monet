...
public final class TerminalRow {
    ...
    public void setChar(int columnToSet, int codePoint, long style) {
        ...
        int newSpaceUsed = mSpaceUsed + javaCharDifference;
        if (newSpaceUsed < Short.MIN_VALUE || newSpaceUsed > Short.MAX_VALUE) {
            throw new ArithmeticException("Resulting mSpaceUsed value is out of range for a short: " + newSpaceUsed);
        }
        mSpaceUsed = (short) newSpaceUsed;
