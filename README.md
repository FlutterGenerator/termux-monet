...
- Check [`TermuxConstants`](https://github.com/FlutterGenerator/termux-monet/blob/master/termux-shared/src/master/java/com/termux/shared/termux/TermuxConstants.java) javadocs for instructions on what changes to make in the app to change package name.
